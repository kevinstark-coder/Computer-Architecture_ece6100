...
--------------------------------------------
Cycle count: 5, retired instructions: 1
 IF:     ID:     EX:     MA:    
      5       4       3       2 
...
--------------------------------------------
Cycle count: 6, retired instructions: 2
 IF:     ID:     EX:     MA:    
      6       5       4       3 
...
--------------------------------------------
Cycle count: 7, retired instructions: 3
 IF:     ID:     EX:     MA:    
      7       6       5       4 
...
--------------------------------------------
Cycle count: 8, retired instructions: 4
 IF:     ID:     EX:     MA:    
      8       7       6       5 
...
--------------------------------------------
Cycle count: 9, retired instructions: 5
 IF:     ID:     EX:     MA:    
      9       8       7       6 
...
--------------------------------------------
Cycle count: 10, retired instructions: 6
 IF:     ID:     EX:     MA:    
     10       9       8       7 
...
--------------------------------------------
Cycle count: 11, retired instructions: 7
 IF:     ID:     EX:     MA:    
     11      10       9       8 
...
Moving I11 from IF to ID...
	...
	(STALL) I11 in P0's ID stage has a RAW hazard on I10 in P0's EX stage! (cc dependency)
Stalling P0's IF because I11 is stalled in ID!

--------------------------------------------
Cycle count: 12, retired instructions: 8
 IF:     ID:     EX:     MA:    
     11      11      10       9 
(11 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
(11 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
...
Moving I11 from IF to ID...
	(STALL) I11 in P0's ID stage has a RAW hazard on I10 in P0's MA stage! (cc dependency)
Stalling P0's IF because I11 is stalled in ID!

--------------------------------------------
Cycle count: 13, retired instructions: 9
 IF:     ID:     EX:     MA:    
     11      11  ------      10 
(11 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
(11 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
...
--------------------------------------------
Cycle count: 14, retired instructions: 10
 IF:     ID:     EX:     MA:    
     12      11  ------  ------ 
...
--------------------------------------------
Cycle count: 15, retired instructions: 10
 IF:     ID:     EX:     MA:    
     13      12      11  ------ 
...
--------------------------------------------
Cycle count: 16, retired instructions: 10
 IF:     ID:     EX:     MA:    
     14      13      12      11 
...
--------------------------------------------
Cycle count: 17, retired instructions: 11
 IF:     ID:     EX:     MA:    
     15      14      13      12 
...
--------------------------------------------
Cycle count: 18, retired instructions: 12
 IF:     ID:     EX:     MA:    
     16      15      14      13 
...
--------------------------------------------
Cycle count: 19, retired instructions: 13
 IF:     ID:     EX:     MA:    
     17      16      15      14 
...
--------------------------------------------
Cycle count: 20, retired instructions: 14
 IF:     ID:     EX:     MA:    
     18      17      16      15 
...
Moving I18 from IF to ID...
	(STALL) I18 in P0's ID stage has a RAW hazard on I16 in P0's MA stage! (cc dependency)
	(STALL) I18 in P0's ID stage has a RAW hazard on I17 in P0's EX stage! (cc dependency)
Stalling P0's IF because I18 is stalled in ID!

--------------------------------------------
Cycle count: 21, retired instructions: 15
 IF:     ID:     EX:     MA:    
     18      18      17      16 
(18 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
(18 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
...
Moving I18 from IF to ID...
	(STALL) I18 in P0's ID stage has a RAW hazard on I17 in P0's MA stage! (cc dependency)
Stalling P0's IF because I18 is stalled in ID!

--------------------------------------------
Cycle count: 22, retired instructions: 16
 IF:     ID:     EX:     MA:    
     18      18  ------      17 
(18 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
(18 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
...
--------------------------------------------
Cycle count: 23, retired instructions: 17
 IF:     ID:     EX:     MA:    
     19      18  ------  ------ 
...
--------------------------------------------
Cycle count: 24, retired instructions: 17
 IF:     ID:     EX:     MA:    
     20      19      18  ------ 
...
--------------------------------------------
Cycle count: 25, retired instructions: 17
 IF:     ID:     EX:     MA:    
     21      20      19      18 
...
--------------------------------------------
Cycle count: 26, retired instructions: 18
 IF:     ID:     EX:     MA:    
     22      21      20      19 
...
--------------------------------------------
Cycle count: 27, retired instructions: 19
 IF:     ID:     EX:     MA:    
     23      22      21      20 
...
--------------------------------------------
Cycle count: 28, retired instructions: 20
 IF:     ID:     EX:     MA:    
     24      23      22      21 
...
--------------------------------------------
Cycle count: 29, retired instructions: 21
 IF:     ID:     EX:     MA:    
     25      24      23      22 
...
--------------------------------------------
Cycle count: 30, retired instructions: 22
 IF:     ID:     EX:     MA:    
     26      25      24      23 
...
--------------------------------------------
Cycle count: 31, retired instructions: 23
 IF:     ID:     EX:     MA:    
     27      26      25      24 
...
--------------------------------------------
Cycle count: 32, retired instructions: 24
 IF:     ID:     EX:     MA:    
     28      27      26      25 
...
--------------------------------------------
Cycle count: 33, retired instructions: 25
 IF:     ID:     EX:     MA:    
     29      28      27      26 
...
--------------------------------------------
Cycle count: 34, retired instructions: 26
 IF:     ID:     EX:     MA:    
     30      29      28      27 
...
Moving I30 from IF to ID...
	(STALL) I30 in P0's ID stage has a RAW hazard on I28 in P0's MA stage! (cc dependency)
Stalling P0's IF because I30 is stalled in ID!

--------------------------------------------
Cycle count: 35, retired instructions: 27
 IF:     ID:     EX:     MA:    
     30      30      29      28 
(30 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(30 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 36, retired instructions: 28
 IF:     ID:     EX:     MA:    
     31      30  ------      29 
...
--------------------------------------------
Cycle count: 37, retired instructions: 29
 IF:     ID:     EX:     MA:    
     32      31      30  ------ 
...
--------------------------------------------
Cycle count: 38, retired instructions: 29
 IF:     ID:     EX:     MA:    
     33      32      31      30 
...
--------------------------------------------
Cycle count: 39, retired instructions: 30
 IF:     ID:     EX:     MA:    
     34      33      32      31 
...
--------------------------------------------
Cycle count: 40, retired instructions: 31
 IF:     ID:     EX:     MA:    
     35      34      33      32 
...
Moving I35 from IF to ID...
	(STALL) I35 in P0's ID stage has a RAW hazard on I34 in P0's EX stage! (cc dependency)
Stalling P0's IF because I35 is stalled in ID!

--------------------------------------------
Cycle count: 41, retired instructions: 32
 IF:     ID:     EX:     MA:    
     35      35      34      33 
(35 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(35 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
Moving I35 from IF to ID...
	(STALL) I35 in P0's ID stage has a RAW hazard on I34 in P0's MA stage! (cc dependency)
Stalling P0's IF because I35 is stalled in ID!

--------------------------------------------
Cycle count: 42, retired instructions: 33
 IF:     ID:     EX:     MA:    
     35      35  ------      34 
(35 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(35 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 43, retired instructions: 34
 IF:     ID:     EX:     MA:    
     36      35  ------  ------ 
...
--------------------------------------------
Cycle count: 44, retired instructions: 34
 IF:     ID:     EX:     MA:    
     37      36      35  ------ 
...
--------------------------------------------
Cycle count: 45, retired instructions: 34
 IF:     ID:     EX:     MA:    
     37      37      36      35 
(37 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(37 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 46, retired instructions: 35
 IF:     ID:     EX:     MA:    
     37      37  ------      36 
(37 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(37 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 47, retired instructions: 36
 IF:     ID:     EX:     MA:    
     38      37  ------  ------ 
...
--------------------------------------------
Cycle count: 48, retired instructions: 36
 IF:     ID:     EX:     MA:    
     39      38      37  ------ 
...
Moving I39 from IF to ID...
	(STALL) I39 in P0's ID stage has a RAW hazard on I38 in P0's EX stage! (cc dependency)
Stalling P0's IF because I39 is stalled in ID!

--------------------------------------------
Cycle count: 49, retired instructions: 36
 IF:     ID:     EX:     MA:    
     39      39      38      37 
(39 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(39 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
Moving I39 from IF to ID...
	(STALL) I39 in P0's ID stage has a RAW hazard on I38 in P0's MA stage! (cc dependency)
Stalling P0's IF because I39 is stalled in ID!

--------------------------------------------
Cycle count: 50, retired instructions: 37
 IF:     ID:     EX:     MA:    
     39      39  ------      38 
(39 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(39 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 51, retired instructions: 38
 IF:     ID:     EX:     MA:    
     40      39  ------  ------ 
...
--------------------------------------------
Cycle count: 52, retired instructions: 38
 IF:     ID:     EX:     MA:    
     41      40      39  ------ 
...
--------------------------------------------
Cycle count: 53, retired instructions: 38
 IF:     ID:     EX:     MA:    
     42      41      40      39 
...
--------------------------------------------
Cycle count: 54, retired instructions: 39
 IF:     ID:     EX:     MA:    
     43      42      41      40 
...
--------------------------------------------
Cycle count: 55, retired instructions: 40
 IF:     ID:     EX:     MA:    
     44      43      42      41 
...
--------------------------------------------
Cycle count: 56, retired instructions: 41
 IF:     ID:     EX:     MA:    
     45      44      43      42 
...
--------------------------------------------
Cycle count: 57, retired instructions: 42
 IF:     ID:     EX:     MA:    
     45      45      44      43 
(45 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(45 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 58, retired instructions: 43
 IF:     ID:     EX:     MA:    
     46      45  ------      44 
...
--------------------------------------------
Cycle count: 59, retired instructions: 44
 IF:     ID:     EX:     MA:    
     47      46      45  ------ 
...
Moving I47 from IF to ID...
	(STALL) I47 in P0's ID stage has a RAW hazard on I46 in P0's EX stage! (cc dependency)
Stalling P0's IF because I47 is stalled in ID!

--------------------------------------------
Cycle count: 60, retired instructions: 44
 IF:     ID:     EX:     MA:    
     47      47      46      45 
(47 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(47 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
Moving I47 from IF to ID...
	(STALL) I47 in P0's ID stage has a RAW hazard on I46 in P0's MA stage! (cc dependency)
Stalling P0's IF because I47 is stalled in ID!

--------------------------------------------
Cycle count: 61, retired instructions: 45
 IF:     ID:     EX:     MA:    
     47      47  ------      46 
(47 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(47 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 62, retired instructions: 46
 IF:     ID:     EX:     MA:    
     48      47  ------  ------ 
...
--------------------------------------------
Cycle count: 63, retired instructions: 46
 IF:     ID:     EX:     MA:    
     49      48      47  ------ 
...
--------------------------------------------
Cycle count: 64, retired instructions: 46
 IF:     ID:     EX:     MA:    
     50      49      48      47 
...
--------------------------------------------
Cycle count: 65, retired instructions: 47
 IF:     ID:     EX:     MA:    
     51      50      49      48 
...
--------------------------------------------
Cycle count: 66, retired instructions: 48
 IF:     ID:     EX:     MA:    
     52      51      50      49 
...
--------------------------------------------
Cycle count: 67, retired instructions: 49
 IF:     ID:     EX:     MA:    
     53      52      51      50 
...
--------------------------------------------
Cycle count: 68, retired instructions: 50
 IF:     ID:     EX:     MA:    
     54      53      52      51 
...
--------------------------------------------
Cycle count: 69, retired instructions: 51
 IF:     ID:     EX:     MA:    
     55      54      53      52 
...
Moving I55 from IF to ID...
	(STALL) I55 in P0's ID stage has a RAW hazard on I54 in P0's EX stage! (cc dependency)
Stalling P0's IF because I55 is stalled in ID!

--------------------------------------------
Cycle count: 70, retired instructions: 52
 IF:     ID:     EX:     MA:    
     55      55      54      53 
(55 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
(55 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
...
Moving I55 from IF to ID...
	(STALL) I55 in P0's ID stage has a RAW hazard on I54 in P0's MA stage! (cc dependency)
Stalling P0's IF because I55 is stalled in ID!

--------------------------------------------
Cycle count: 71, retired instructions: 53
 IF:     ID:     EX:     MA:    
     55      55  ------      54 
(55 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
(55 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 0
...
--------------------------------------------
Cycle count: 72, retired instructions: 54
 IF:     ID:     EX:     MA:    
     56      55  ------  ------ 
...
--------------------------------------------
Cycle count: 73, retired instructions: 54
 IF:     ID:     EX:     MA:    
     57      56      55  ------ 
...
--------------------------------------------
Cycle count: 74, retired instructions: 54
 IF:     ID:     EX:     MA:    
     58      57      56      55 
...
--------------------------------------------
Cycle count: 75, retired instructions: 55
 IF:     ID:     EX:     MA:    
     59      58      57      56 
...
--------------------------------------------
Cycle count: 76, retired instructions: 56
 IF:     ID:     EX:     MA:    
     60      59      58      57 
...
--------------------------------------------
Cycle count: 77, retired instructions: 57
 IF:     ID:     EX:     MA:    
     61      60      59      58 
...
--------------------------------------------
Cycle count: 78, retired instructions: 58
 IF:     ID:     EX:     MA:    
     62      61      60      59 
...
Moving I62 from IF to ID...
	(STALL) I62 in P0's ID stage has a RAW hazard on I61 in P0's EX stage! (cc dependency)
Stalling P0's IF because I62 is stalled in ID!

--------------------------------------------
Cycle count: 79, retired instructions: 59
 IF:     ID:     EX:     MA:    
     62      62      61      60 
(62 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(62 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
Moving I62 from IF to ID...
	(STALL) I62 in P0's ID stage has a RAW hazard on I61 in P0's MA stage! (cc dependency)
Stalling P0's IF because I62 is stalled in ID!

--------------------------------------------
Cycle count: 80, retired instructions: 60
 IF:     ID:     EX:     MA:    
     62      62  ------      61 
(62 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
(62 : BR) dest: -1, src1: -1, src2: -1 , ccread: 1, ccwrite: 0, br_dir: 1
...
--------------------------------------------
Cycle count: 81, retired instructions: 61
 IF:     ID:     EX:     MA:    
     63      62  ------  ------ 
...
--------------------------------------------
Cycle count: 82, retired instructions: 61
 IF:     ID:     EX:     MA:    
     64      63      62  ------ 
...
--------------------------------------------
Cycle count: 83, retired instructions: 61
 IF:     ID:     EX:     MA:    
     65      64      63      62 
...
--------------------------------------------
Cycle count: 84, retired instructions: 62
 IF:     ID:     EX:     MA:    
     66      65      64      63 
...
--------------------------------------------
Cycle count: 85, retired instructions: 63
 IF:     ID:     EX:     MA:    
     67      66      65      64 
...
--------------------------------------------
Cycle count: 86, retired instructions: 64
 IF:     ID:     EX:     MA:    
     68      67      66      65 
...
--------------------------------------------
Cycle count: 87, retired instructions: 65
 IF:     ID:     EX:     MA:    
     69      68      67      66 
...
--------------------------------------------
Cycle count: 88, retired instructions: 66
 IF:     ID:     EX:     MA:    
     70      69      68      67 
...
--------------------------------------------
Cycle count: 89, retired instructions: 67
 IF:     ID:     EX:     MA:    
     71      70      69      68 
...
--------------------------------------------
Cycle count: 90, retired instructions: 68
 IF:     ID:     EX:     MA:    
     72      71      70      69 
...
--------------------------------------------
Cycle count: 91, retired instructions: 69
 IF:     ID:     EX:     MA:    
     73      72      71      70 
...
--------------------------------------------
Cycle count: 92, retired instructions: 70
 IF:     ID:     EX:     MA:    
     74      73      72      71 
...
--------------------------------------------
Cycle count: 93, retired instructions: 71
 IF:     ID:     EX:     MA:    
     75      74      73      72 
...
--------------------------------------------
Cycle count: 94, retired instructions: 72
 IF:     ID:     EX:     MA:    
     76      75      74      73 
...
--------------------------------------------
Cycle count: 95, retired instructions: 73
 IF:     ID:     EX:     MA:    
     77      76      75      74 
...
--------------------------------------------
Cycle count: 96, retired instructions: 74
 IF:     ID:     EX:     MA:    
     78      77      76      75 
...
--------------------------------------------
Cycle count: 97, retired instructions: 75
 IF:     ID:     EX:     MA:    
     79      78      77      76 
...
--------------------------------------------
Cycle count: 98, retired instructions: 76
 IF:     ID:     EX:     MA:    
     80      79      78      77 
...
--------------------------------------------
Cycle count: 99, retired instructions: 77
 IF:     ID:     EX:     MA:    
     81      80      79      78 
...
--------------------------------------------
Cycle count: 100, retired instructions: 78
 IF:     ID:     EX:     MA:    
     82      81      80      79 
...
--------------------------------------------
Cycle count: 101, retired instructions: 79
 IF:     ID:     EX:     MA:    
     83      82      81      80 
...
--------------------------------------------
Cycle count: 102, retired instructions: 80
 IF:     ID:     EX:     MA:    
     84      83      82      81 
...
--------------------------------------------
Cycle count: 103, retired instructions: 81
 IF:     ID:     EX:     MA:    
     85      84      83      82 
...
--------------------------------------------
Cycle count: 104, retired instructions: 82
 IF:     ID:     EX:     MA:    
     86      85      84      83 
...
--------------------------------------------
Cycle count: 105, retired instructions: 83
 IF:     ID:     EX:     MA:    
     87      86      85      84 
...
--------------------------------------------
Cycle count: 106, retired instructions: 84
 IF:     ID:     EX:     MA:    
     88      87      86      85 
...
--------------------------------------------
Cycle count: 107, retired instructions: 85
 IF:     ID:     EX:     MA:    
     89      88      87      86 
...
--------------------------------------------
Cycle count: 108, retired instructions: 86
 IF:     ID:     EX:     MA:    
     90      89      88      87 
...
--------------------------------------------
Cycle count: 109, retired instructions: 87
 IF:     ID:     EX:     MA:    
     91      90      89      88 
...
--------------------------------------------
Cycle count: 110, retired instructions: 88
 IF:     ID:     EX:     MA:    
     92      91      90      89 
...
--------------------------------------------
Cycle count: 111, retired instructions: 89
 IF:     ID:     EX:     MA:    
     93      92      91      90 
...
--------------------------------------------
Cycle count: 112, retired instructions: 90
 IF:     ID:     EX:     MA:    
     94      93      92      91 
...
--------------------------------------------
Cycle count: 113, retired instructions: 91
 IF:     ID:     EX:     MA:    
     95      94      93      92 
...
--------------------------------------------
Cycle count: 114, retired instructions: 92
 IF:     ID:     EX:     MA:    
     96      95      94      93 
...
--------------------------------------------
Cycle count: 115, retired instructions: 93
 IF:     ID:     EX:     MA:    
     97      96      95      94 
...
--------------------------------------------
Cycle count: 116, retired instructions: 94
 IF:     ID:     EX:     MA:    
     98      97      96      95 
...
--------------------------------------------
Cycle count: 117, retired instructions: 95
 IF:     ID:     EX:     MA:    
     99      98      97      96 
...
--------------------------------------------
Cycle count: 118, retired instructions: 96
 IF:     ID:     EX:     MA:    
    100      99      98      97 
...
--------------------------------------------
Cycle count: 119, retired instructions: 97
 IF:     ID:     EX:     MA:    
 ------     100      99      98 
 ------ 
(100 : LD) dest: 27, src1: -1, src2: -1 , ccread: 0, ccwrite: 1, br_dir: 0
...
--------------------------------------------
Cycle count: 120, retired instructions: 98
 IF:     ID:     EX:     MA:    
 ------  ------     100      99 
 ------ 
 ------ 
...
--------------------------------------------
Cycle count: 121, retired instructions: 99
 IF:     ID:     EX:     MA:    
 ------  ------  ------     100 
 ------ 
 ------ 
...
--------------------------------------------
Cycle count: 122, retired instructions: 100
 IF:     ID:     EX:     MA:    
 ------  ------  ------  ------ 
 ------ 
 ------ 
